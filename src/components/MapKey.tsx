...
export const MapKey = ({ map }: { map: Map }) => {
  const images: KeyItem[] = [
    { image: "/large-ruin.png", label: "Large Ruin", id: "large ruin", width: "w-1/4", height: "h-30", imageHeight: "h-20" },
    { image: "/medium-ruin.png", label: "Small Ruin", id: "small ruin", width: "w-1/4", height: "h-30", imageHeight: "h-20" },
    { image: "/cargo-container.png", label: "Cargo Container", id: "cargo container", width: "w-1/4", height: "h-30", imageHeight: "h-20" },
    { image: "/prototype-ruin.png", label: "Prototype Ruin", id: "prototype ruin", width: "w-1/4", height: "h-30", imageHeight: "h-20" },
  ...
  return <div className={`h-32 flex items-bottom gap-3 w-full flex-wrap`}>
    {images.map((item, index) => (
      <div key={index} className={`flex flex-col items-center ${item.width} ${item.height}`}>
